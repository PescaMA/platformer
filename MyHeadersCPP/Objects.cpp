...
void RayJump::Start::specialEffect()
{
    ...
    myPlayer.xCoord=v[xa]+imageSize.x/2-myPlayer.hitbox.x-myPlayer.hitbox.width/2;
    myPlayer.yCoord=v[ya]+imageSize.y/2-myPlayer.hitbox.y-myPlayer.hitbox.height/2;
}
