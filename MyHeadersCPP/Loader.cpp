...
{
    myStart=new Start(0,2,ASSET_SPECIAL,0, {-4,0,40,64}); /// hitbox big for player to fit inside
    myFinish=new Finish(1,2,ASSET_SPECIAL,32, {0,0,32,32});
    Object static *AllObjectss[]=/// taking advantage of easier definition
    {
        ...
        ///page 1:
        ( Block1= new Block(10,1,ASSET_BLOCKS,0,{0,0,32,32})),
        ( Block2= new Block(11,1,ASSET_BLOCKS,32,{0,0,32,32})),
        ( Block3= new Block(12,1,ASSET_BLOCKS,64,{0,0,32,32})),
        ( Block4= new Block(13,1,ASSET_BLOCKS,96,{0,0,32,32})),
        ( Block5= new Block(14,1,ASSET_BLOCKS,128,{0,0,32,32})),
        /// page 2:
        myStart,
        myFinish
    };
